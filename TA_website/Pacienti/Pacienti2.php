...
<ul>
  ...
  <li><a class="active" href="Pacienti2.php">Cauta pacient</a></li>
...
<center>
<h2>Cautare pacient</h2>
<form  method = post >
<input type="text" name ="nume1" placeholder="Nume"></input><br><br>


<input type="submit" value="Cauta" name = "cauta"></input><br>
</form>
<?php
...
$sql = "SELECT * FROM pacienti where Nume like '$nume1%' ";
